...
public class TagReaderKey_ParcelableCreator
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Tyler.Drive.RFID.TagReaderKey+ParcelableCreator, Tyler.Drive.RFID, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", TagReaderKey_ParcelableCreator.class, __md_methods);
	}


	public TagReaderKey_ParcelableCreator () throws java.lang.Throwable
	{
		super ();
		if (getClass () == TagReaderKey_ParcelableCreator.class)
			mono.android.TypeManager.Activate ("Tyler.Drive.RFID.TagReaderKey+ParcelableCreator, Tyler.Drive.RFID, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
