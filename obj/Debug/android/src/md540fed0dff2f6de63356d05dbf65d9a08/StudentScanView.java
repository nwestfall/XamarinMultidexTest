...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Tyler.Drive.Ridership.Controls.StudentScanView, Tyler.Drive.Ridership, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", StudentScanView.class, __md_methods);
	}


	public StudentScanView (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == StudentScanView.class)
			mono.android.TypeManager.Activate ("Tyler.Drive.Ridership.Controls.StudentScanView, Tyler.Drive.Ridership, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public StudentScanView (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == StudentScanView.class)
			mono.android.TypeManager.Activate ("Tyler.Drive.Ridership.Controls.StudentScanView, Tyler.Drive.Ridership, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}


	public StudentScanView (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == StudentScanView.class)
	...
	public StudentScanView (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == StudentScanView.class)
