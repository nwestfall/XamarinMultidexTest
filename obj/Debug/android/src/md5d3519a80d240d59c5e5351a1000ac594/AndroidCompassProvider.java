...
public class AndroidCompassProvider
	extends md5d3519a80d240d59c5e5351a1000ac594.CompassProvider
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Esri.ArcGISRuntime.Location.AndroidCompassProvider, Esri.ArcGISRuntime, Version=100.1.0.0, Culture=neutral, PublicKeyToken=8fc3cc631e44ad86", AndroidCompassProvider.class, __md_methods);
	}


	public AndroidCompassProvider () throws java.lang.Throwable
	{
		super ();
		if (getClass () == AndroidCompassProvider.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.Location.AndroidCompassProvider, Esri.ArcGISRuntime, Version=100.1.0.0, Culture=neutral, PublicKeyToken=8fc3cc631e44ad86", "", this, new java.lang.Object[] {  });
	}
