...
public class AndroidDeviceInteractionHandler
	extends md5d1b56e5099a02cfcebb7bf5431e73a8e.UserInteractionHandler
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Esri.ArcGISRuntime.UI.AndroidDeviceInteractionHandler, Esri.ArcGISRuntime, Version=100.1.0.0, Culture=neutral, PublicKeyToken=8fc3cc631e44ad86", AndroidDeviceInteractionHandler.class, __md_methods);
	}


	public AndroidDeviceInteractionHandler () throws java.lang.Throwable
	{
		super ();
		if (getClass () == AndroidDeviceInteractionHandler.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.UI.AndroidDeviceInteractionHandler, Esri.ArcGISRuntime, Version=100.1.0.0, Culture=neutral, PublicKeyToken=8fc3cc631e44ad86", "", this, new java.lang.Object[] {  });
	}

	public AndroidDeviceInteractionHandler (md57e9adfe234148a34f9aeb4cfea507483.GeoView p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == AndroidDeviceInteractionHandler.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.UI.AndroidDeviceInteractionHandler, Esri.ArcGISRuntime, Version=100.1.0.0, Culture=neutral, PublicKeyToken=8fc3cc631e44ad86", "Esri.ArcGISRuntime.UI.Controls.GeoView, Esri.ArcGISRuntime, Version=100.1.0.0, Culture=neutral, PublicKeyToken=8fc3cc631e44ad86", this, new java.lang.Object[] { p0 });
	}
